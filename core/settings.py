...
SECRET_KEY = 'django-insecure-0kz_%yla_*t-o)=twr^1!(l20mce7dz8ok)#a_s=6cbwabt!m4'
...
INSTALLED_APPS = [
    ...
    'compressor',  # Move after staticfiles
    'accounts',
    'org',
    'inventory',
    'dashboards', 
...
COMPRESS_ENABLED = not DEBUG  # Compress only in production (when DEBUG=False)
